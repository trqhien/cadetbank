...
class Styles {
  ...
  static ThemeData get lightModeTheme => ThemeData(
    ...
    textTheme: TextTheme(
      ...
      bodySmall: _jekoStyle.fontSize10.primaryBlackColor,
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      labelStyle: _jekoStyle.fontSize16.primaryBlackColor.semiBold,
      hintStyle: _jekoStyle.fontSize16.grey4Color,
      prefixStyle: _jekoStyle.fontSize16.primaryBlackColor.semiBold.textHeight(1),
      ...
      errorStyle: _jekoStyle.fontSize10.errorColor
    ),
    textButtonTheme: TextButtonThemeData(
      style: ButtonStyle(
        ...
        textStyle: MaterialStatePropertyAll(_jekoStyle.fontSize16),
  ...
  static ThemeData get darkModeTheme => ThemeData(
    ...
    textTheme: TextTheme(
      ...
      bodySmall: _jekoStyle.fontSize10.primaryWhiteColor,
    ),
