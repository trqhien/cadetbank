...
abstract class Success<T> extends Result<T> {
  factory Success(final T result) = _$Success<T>;
  Success._() : super._();
...
class _$Failure<T> extends Failure<T> {
  _$Failure(this.failure) : super._();
...
abstract class Failure<T> extends Result<T> {
  factory Failure(final AppFailure failure) = _$Failure<T>;
  Failure._() : super._();
